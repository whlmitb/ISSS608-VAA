...
The wind rose chart shows that the data is mainly concentrated between 0 and 45 degrees, which may suggest that the main source of wind is from the north to northeast direction. In addition, a trend of increasing wind speed from year to year was observed, which further supports the accuracy of future climate predictions. \## 3.5 Verifying climate change_5 - Sea level rise
