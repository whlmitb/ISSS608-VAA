...
These code and plot exercises run into problems when trying to execute them simultaneously, but succeed when executed separately. But on render, the execution still fails.
