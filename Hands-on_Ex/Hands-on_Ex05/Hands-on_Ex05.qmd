...
These code and plot exercises run into problems when trying to execute them simultaneously, but succeed when executed separately. So I put this set of code in [Hands-on Exercise 5 Appendix]().
